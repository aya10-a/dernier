...
// bx bx-spa:fleur, bx bx-happy-heart-eyes:visage avec les yeux coeurs, bx bx-female:femme
        {
            id: "Beauty",
            label: "Beauty",
            ...
            subItems: [
                {
                    ...
                    childItems: [
                        ...
                        { id: 2, label: "Robe", link: "/auth-signin-cover" },
                        { id: 2, label: "Chemise", link: "/auth-signin-cover" },
                        { id: 2, label: "Sac", link: "/auth-signin-cover" },
                    ]
                },
                {
                    id: "Men",
